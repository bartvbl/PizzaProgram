...
public class ProgramWindowFrameView extends FrameView {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(desktopapplication1.PizzaProgram.class).getContext().getResourceMap(ProgramWindowFrameView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(desktopapplication1.PizzaProgram.class).getContext().getActionMap(ProgramWindowFrameView.class, this);
