...
public class Order {
	 ...
	 * @param dishes
	 *            - a list of dishes in the order, not null
	 * @param status
	 ...
	 */
	public Order(int id, Customer customer, ArrayList<OrderDish> dishes,
			String status, String deliveryMethod, String comment) {
		if (id < 0) {
		...
		} else if (!(status.equals(Order.PICKUP_AT_RESTAURANT) || status
