...
/**
 * The Module is a basic part of the system. It communicates to other modules through the event system.
 * @author Bart
 *
 */
public abstract class Module implements EventHandler{
	...
	/**
	 * Should be implemented by a child class. Handles an incoming event from the event dispatcher, for which this module has registered.
	 */
