...
/**
 * The EventDispatcher takes in events and lets objects register for certain
 * event types. When an event is dispatched, it will notify all listeners
...
public class EventDispatcher {
	...
	/**
	 * Notifies (e.g. calls all listener functions) all event listeners about
	...
	/**
	 * Adds an event listener to the specified event type. When the event is
	 * dispatched, the event dispatcher will call the handleEvent() function if
	 * the event has not stopped propagation.
	 * 
	 * @param listenerModule
	 *            The object that implements the EventHandler interface, that
	 *            will be notified upon occurrence of the event
	 * @param eventType
	 *            The string representing the event type. A constand from
	 *            EventType should be used for this.
	 */
	...
	/**
	 * Creates a new entry in the HashMap holding the listener lists if the
	 * inserted event type does not yet exist
	 * 
	 * @param eventType
	 *            The event type to be added upon non-existence
	 */
	...
	/**
	 * A function to check whether an event type has been added to the list of
	 * known events in the hash map
	 * 
	 * @param eventType
	 *            The name of the event to check existence of
