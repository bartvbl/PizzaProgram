...
/**
 * A class used to print out components of the GUI, specifically the receipt of
 * an order
 * 
...
public class PrintUtilities implements Printable {
	...
	/**
	 * The method that can be called to print out components. It invokes the
	 * private constructor of PrintUtilities, such that it can be sent to the
	 * printer.
	 * 
	...
	/**
	 * The constructor of PrintUtilities is private. To print a component, use
	 * printComponent().
	 * 
	 * @param componentToBePrinted
	...
	/**
	 * Draws the component on the inserted graphics, so that the printer can
	 * print it
	 */
	 ...
	 * 
	 * @param component
	 *            The component to enable double buffering on
	 */
