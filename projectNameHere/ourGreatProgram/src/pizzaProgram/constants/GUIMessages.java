...
/**
 * A class containing all the messages for error and information messages that
...
public class GUIMessages {
	/*
	 * Messages displayed while adding/editing extras
	 */
	...
	public static final String TOO_MANY_DECIMAL_SEPARATORS_IN_VALUE = "Tall kan ikke inneholde mer enn ett komma!";
	public static final String ILLEGAL_NUMBER_INPUT = "Du har skrevet inn noe som ikke er et tall!";
	public static final String TOO_MANY_DIGITS_AFTER_DECIMAL_SEPARATOR = "Tall må ha nøyaktig to siffer etter komma!";
	...
	/*
	 * Messages displayed while adding/editing dishes
	 */
	...
	/*
	 * Messages displayed while adding/editing/deleting customers
	 */
	...
	/*
	 * Messages displayed while adding orders
	 */
