...
/**
 * This class is for initilizing the deliverygui, since deliveryview is
 * autogenerated and should not be edited, all initalisation and hiding/showing
...
public class DeliverGUI extends GUIModule implements EventHandler {
	/**
	 * Holds a reference to the DeliveryView instance so that it can be used to
	 * display and hide it
	 */
	...
	/**
	 * A list of the orders that are currently being displayed in the delivery
	 * view
	 */
	...
	/**
	 * The constructor, creates the deliveryView Jpanel, creates event handlers
	 * and registers the JPanel at the program's main window
	 * 
	 * @param mainWindow
	 *            a reference to the program's main window
	...
	/**
	 * Initializes all components and fills them with default data
	 */
	...
	/**
	 * Handles events that are directed at the delivery GUI module, and calls
	 * the appropiate internal event handling functions
	 */
	@Override
