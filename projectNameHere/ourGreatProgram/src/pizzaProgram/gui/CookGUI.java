...
/**
 * This class is for initializing the cookgui, since cookview is autogenerated
...
public class CookGUI extends GUIModule implements EventHandler {
	...
	/**
	 * A list of the currently displayed order list, as reference when updating
	 * the GUI
	 */
	...
	/**
	 * Stores the reference to the cookViewEventHandler for later use
	 * (internally)
	 */
	private CookGUI_CookViewEventHandler cookViewEventHandler;

	/**
	 * The constructor, which creates the cookView Jpanel, creates event
