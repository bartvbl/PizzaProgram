...
public class MenuBarEventHandler implements ActionListener {
	...
	/**
	 * A hashTable linking MenuItem instances to Strings representing the event
	 * type they produce
	 */
	...
	/**
	 * A function that gets called by java AWT when the user clicks on a menu
	 * item
	 */
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (!(actionEvent.getSource() instanceof JMenuItem)) {
			System.out
					.println("ERROR: events handled by the MenuBar class can only originate from JMenuItem instances!");
			return;
		}
	 ...
	 * 
	 * @param menuItem
	 *            The menu item to find the event type for
	 * @return The associated event type of the event that can be sent to the
	 *         system
	 */
	 ...
	 * 
	 * @param menuItem
	 *            The JMenuItem instance
	 * @param eventName
	 *            The event type to associate interaction events produced by the
	 *            JMenuItem with
	 */
	...
	/**
	 * Associates all JMenuItem events with events that can be sent to the
	 * system
	 */
	private void fillMenuItemsTable() {
		this.registerComponentEvent(ProgramWindowFrameView.showSettingsGUIMenuItem,
				EventType.OPEN_SETTINGS_WINDOW_REQUESTED);
		this.registerComponentEvent(ProgramWindowFrameView.refreshDataMenuItem,
		...
		this.registerComponentEvent(ProgramWindowFrameView.showDeliveryGUIMenuItem,
				EventType.DELIVERY_GUI_REQUESTED);
		this.registerComponentEvent(ProgramWindowFrameView.showOrderGUIMenuItem,
