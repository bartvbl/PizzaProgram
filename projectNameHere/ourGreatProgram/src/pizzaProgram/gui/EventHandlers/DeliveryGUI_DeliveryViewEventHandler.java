...
public class DeliveryGUI_DeliveryViewEventHandler extends ComponentEventHandler implements ActionListener  {
	...
	/**
	 * Initializes the class, and registers all event listeners that the class will handle
	 * @param deliveryGUI
	 */
	...
	/**
	 * Calls the appropiate event handling function depending on the source of the ActionEvent
	 */
	...
	/**
	 * Searches the database for the keywords written in the order search box, and displays the result in the order list
	 */
	...
	/**
	 * Fetches all undelivered orders from the database and shows them in the order list
	 */
