...
/**
 * A class that temporarily holds order data while the user is creating a new
 * order in the Order GUI
 * 
...
public class OrderGUI_TemporaryOrderDataStorage {
	/**
	 * The customer that is currently ordering something
	 */
	...
	/**
	 * This function generates an UnaddedOrder instance from the provided data,
	 * so that it can be sent to the database. It will then reset the temporary
	 * order storage, so that it can be used again for the next order.
	 * 
	 * @return An UnaddedOrder instance containing all the order information
	 ...
	 * 
	 * @param method
	 *            A value that matches one of the enum values of the
	 *            deliveryMethod column in the database
	 */
	 ...
	 * 
	 * @param customer
	 *            A Customer instance, referring to a row in the Customers table
	 *            in the database
	 */
	 ...
	 * 
	 * @param comments
	 *            A String containing order comments
	 */
	 ...
	 * @param extrasToBeAddedToDish
	 *            The extras that are to be added, and are related to this dish
	 */
	 ...
	 * 
	 * @param indexInTable
	 *            The index of the row as the dish appears in the table in the
	 *            order GUI
	 */
	...
	/**
	 * Duplicates a dish in the order, specified by the index of the row where
	 * the dish is shown in the table in the order GUI
	 * 
	 * @param indexInTable
	 *            The index of the row as the dish appears in the table in the
	 *            order GUI
